...
for idx, img_name in enumerate(sorted(os.listdir(img_path))):
	...
	for jk in range(R.shape[0]//C.num_rois + 1):
		...
		for ii in range(P_cls.shape[1]):
			...
			try:
				...
				x, y, w, h = network_aux_roi.apply_regr(x, y, w, h, tx, ty, tw, th)
			except:
				pass
	...
	for key in bboxes:
		...
		new_boxes, new_probs = network_aux_roi.non_max_suppression_fast(bbox, np.array(probs[key]), overlap_thresh=0.5)
